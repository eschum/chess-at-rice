...
import edu.rice.comp610.model.ball.*;
...
//        //requesting a ball to switch strategies should cause a switchable ball to switch to the expected strategy
//        //requesting a ball to switch strategies should not affect a non-switchable ball
//        //Using spy and mock
//        da.addStrategyListenerBall(switchableTestBallSpy);
//        da.switchStrategyBall("diagonal");
//        assertEquals("switchable ball changes strategy", DiagonalStrategy.getInstance(),
//                switchableTestBallSpy.getStrategy());
//        //assertEquals("non-switchable ball doesn't change strategy", HorizontalStrategy.getInstance(),
//        //        nonSwitchTestBallSpy.getStrategy());
//        //Use mock to also verify a non-switchable ball was never forced to change strategy.
//        //verify(nonSwitchBallMock, never()).setStrategy(VerticalStrategy.getInstance());